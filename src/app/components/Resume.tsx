const Resume = () => {
  return (
    <div className="relative">
      <div className=" mt-5 ml-10 mb-5 py-10 px-12 max-w-[875px] bg-white shadow-[rgba(0,0,5,0.3)_7px_0px_6px_-5px]">
  ...
  automated lifecycle emails. With the new system, manual email template updates were no longer necessary.</li>
      ...
      {/* <div className="z-20 bg-white drop-shadow-lg h-screen w-5 mt-6 ml-6 rotate-1">
      </div> */}

{/* <div className="z-20 absolute top-0 bg-white drop-shadow-lg h-full w-5 mt-4 ml-6 -rotate-[.5px]">
      </div> */}


      </div>
      {/* <div className="z-20 top-0 absolute bg-white drop-shadow-lg h-max w-5 mt-4 ml-6 -rotate-[.5px]">
      </div>
